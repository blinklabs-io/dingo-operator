...
func TestBuildStatefulSet(t *testing.T) {
	t.Run("relay statefulset basics", func(t *testing.T) {
		...
		require.NotNil(t, sts.Spec.Template.Spec.SecurityContext.RunAsUser)
		require.NotNil(t, sts.Spec.Template.Spec.SecurityContext.RunAsGroup)
		require.NotNil(t, sts.Spec.Template.Spec.SecurityContext.FSGroup)
		assert.Equal(t, int64(1000), *sts.Spec.Template.Spec.SecurityContext.RunAsUser)
		assert.Equal(t, int64(1000), *sts.Spec.Template.Spec.SecurityContext.RunAsGroup)
		assert.Equal(t, int64(1000), *sts.Spec.Template.Spec.SecurityContext.FSGroup)
